...
# Evaluation script for NateOn messenger only
# This script will run all evaluations on NateOn data
...
echo "========================================"
echo "NateOn Messenger Evaluation Pipeline"
echo "========================================"
echo ""
...
if [ -f "$PREPROCESSED_FILE" ]; then
    ...
    echo "[Step 1/13] Preprocessing NateOn data with TF-IDF drug keyword substitution..."
...
echo "[Step 2/13] Evaluating fine-tuned bert_base on NateOn..."
...
echo "[Step 3/13] Evaluating fine-tuned roberta_base on NateOn..."
...
echo "[Step 4/13] Evaluating fine-tuned roberta_large on NateOn..."
...
echo "[Step 5/13] Evaluating fine-tuned electra_base on NateOn..."
...
echo "[Step 6/13] Evaluating fine-tuned distillbert_base on NateOn..."
...
echo "[Step 7/13] Evaluating plain bert_base on NateOn..."
...
echo "[Step 8/13] Evaluating plain roberta_base on NateOn..."
...
echo "[Step 9/13] Evaluating plain roberta_large on NateOn..."
...
echo "[Step 10/13] Evaluating plain electra_base on NateOn..."
...
echo "[Step 11/13] Evaluating plain distillbert_base on NateOn..."
...
echo "[Step 12/13] Evaluating Gemini on NateOn..."
...
echo "[Step 13/13] Evaluating OpenAI on NateOn..."
...
echo "========================================"
echo "NateOn Evaluation Pipeline Completed!"
echo "========================================"
echo ""
echo "Results are saved in directories with '_nateon' suffix:"
echo "  - Fine-tuned models: results_*_nateon/"
echo "  - Plain models: results_plain_*_nateon/"
echo "  - Gemini results: results_gemini_*_nateon/"
echo "  - OpenAI results: results_openai_*_nateon/"
echo ""
