...
# Evaluation script for Facebook messenger only
# This script will run all evaluations on Facebook data
...
echo "========================================"
echo "Facebook Messenger Evaluation Pipeline"
echo "========================================"
echo ""
...
echo "[Step 2/13] Evaluating fine-tuned bert_base on Facebook..."
...
echo "[Step 3/13] Evaluating fine-tuned roberta_base on Facebook..."
...
echo "[Step 4/13] Evaluating fine-tuned roberta_large on Facebook..."
...
echo "[Step 5/13] Evaluating fine-tuned electra_base on Facebook..."
...
echo "[Step 6/13] Evaluating fine-tuned distillbert_base on Facebook..."
...
echo "[Step 7/13] Evaluating plain bert_base on Facebook..."
...
echo "[Step 8/13] Evaluating plain roberta_base on Facebook..."
...
echo "[Step 9/13] Evaluating plain roberta_large on Facebook..."
...
echo "[Step 10/13] Evaluating plain electra_base on Facebook..."
...
echo "[Step 11/13] Evaluating plain distillbert_base on Facebook..."
...
echo "[Step 12/13] Evaluating Gemini on Facebook..."
...
echo "[Step 13/13] Evaluating OpenAI on Facebook..."
...
echo "========================================"
echo "Facebook Evaluation Pipeline Completed!"
echo "========================================"
echo ""
...
source /home/minseok/anaconda3/etc/profile.d/conda.sh
conda activate ms 2>/dev/null
echo "Results are saved in directories with '_facebook' suffix:"
echo "  - Fine-tuned models: results_*_facebook/"
echo "  - Plain models: results_plain_*_facebook/"
echo "  - Gemini results: results_gemini_*_facebook/"
echo "  - OpenAI results: results_openai_*_facebook/"
echo ""
