...
# Evaluation script for Band messenger only
# This script will run all evaluations on Band data
...
echo "========================================"
echo "Band Messenger Evaluation Pipeline"
echo "========================================"
echo ""
...
echo "[Step 2/13] Evaluating fine-tuned bert_base on Band..."
...
echo "[Step 3/13] Evaluating fine-tuned roberta_base on Band..."
...
echo "[Step 4/13] Evaluating fine-tuned roberta_large on Band..."
...
echo "[Step 5/13] Evaluating fine-tuned electra_base on Band..."
...
echo "[Step 6/13] Evaluating fine-tuned distillbert_base on Band..."
...
echo "[Step 7/13] Evaluating plain bert_base on Band..."
...
echo "[Step 8/13] Evaluating plain roberta_base on Band..."
...
echo "[Step 9/13] Evaluating plain roberta_large on Band..."
...
echo "[Step 10/13] Evaluating plain electra_base on Band..."
...
echo "[Step 11/13] Evaluating plain distillbert_base on Band..."
...
echo "[Step 12/13] Evaluating Gemini on Band..."
...
echo "[Step 13/13] Evaluating OpenAI on Band..."
...
echo "========================================"
echo "Band Evaluation Pipeline Completed!"
echo "========================================"
echo ""
...
source /home/minseok/anaconda3/etc/profile.d/conda.sh
conda activate ms 2>/dev/null
echo "Results are saved in directories with '_band' suffix:"
echo "  - Fine-tuned models: results_*_band/"
echo "  - Plain models: results_plain_*_band/"
echo "  - Gemini results: results_gemini_*_band/"
echo "  - OpenAI results: results_openai_*_band/"
echo ""
