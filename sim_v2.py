...
# EMBEDDING_MODEL_NAME = "upskyy/bge-m3-korean"  # Sentence embedding model
EMBEDDING_MODEL_NAME = "sigridjineth/ModernBERT-korean-large-preview"
BATCH_SIZE = 32
EPOCHS = 5
...
TEST_SPLIT = 0.2
RANDOM_SEED = 42
LOG_DIR = 'sim_model_logs_v2_2'
MODEL_DIR = 'sim_embedding_v2_2'
...
def compute_embedding(texts):
    """
    Computes sentence embeddings for a list of texts.
    """
    embeddings = embedding_model.encode(texts, convert_to_tensor=True, device=device)
